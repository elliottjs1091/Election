describe('Task 2 - Party Array', function() {
  var box, theParty
  ...
  //   beforeEach(function() {
  //     theParty.addToy('Aardvark', 'Brown', 11.11)
  //   })
  ...
  //     const aToy = theParty.allMyToys[0] 
  ...
  //   beforeEach(function() {
  //     theParty.addToy('Dolly', 'Pink', 33.33)
  //     theParty.addToy('Aardvark', 'Brown', 11.11)
  //     theParty.addToy('Bat', 'Wooden', 22.22)
  //   })
